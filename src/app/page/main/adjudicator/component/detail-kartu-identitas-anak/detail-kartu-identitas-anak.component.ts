...
@Component({
  selector: 'app-detail-kartu-identitas-anak',
  templateUrl: './detail-kartu-identitas-anak.component.html',
  styleUrls: ['./detail-kartu-identitas-anak.component.scss']
})

export class DetailKartuIdentitasAnakComponent implements OnInit {
        ...
        Swal.fire({
          ...
          if (this.document.keputusan === 'Diterima') {
            if (this.document.doc_name == undefined || this.document.doc_name == '') {
              ...
              return this.alertError('Foto Cropping KIA harus diisi');
            }
          }
          const doc = this.prepareDoc();
          doc.NIK = doc.Nik;
    ...
    sendData(doc) {
      this.digitalIdService.validateDocument(doc).subscribe((res: any) => {
        if (res.status_code === 200) {
          ...
          this.router.navigate(['/adjudicator/digital-id/kartu-identitas-anak']).then();
        } else {
    ...
    setComponentData() {
      ...
      this.listViewInfo = {
        ...
        'Detail Identitas': [
          ...
          { isEdit: false, label: 'No. HP', bind: 'phone', required: true },
          ...
          { isEdit: false, label: 'Hubungan Keluarga', bind: 'hubungan_keluarga', type: 'dropdown', options: this.hubunganKeluargaOptions },
      ...
      this.listVerifikasi = [
        { label: 'Data KIA dan Kartu Fisik KIA sesuai?', bind: 'doc_adj_key1_status' },
        { label: 'Foto wajah dan foto pada kartu fisik KIA sesuai?', bind: 'doc_adj_key2_status' },
