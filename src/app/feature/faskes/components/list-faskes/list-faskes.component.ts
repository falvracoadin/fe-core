...
@Component({
  selector: 'app-list-faskes',
  templateUrl: './list-faskes.component.html',
  styleUrls: ['./list-faskes.component.scss']
})

export class ListFaskesComponent implements OnInit {
        ...
        list: [
          {
            ...
            hospital: 'Rumah Sakit 1',
            address: {
              name : 'Soekarno-Hatta St No.644, Manjahlega, Rancasari, Bandung City, West Java 40286',
              city : 'Jakarta',
