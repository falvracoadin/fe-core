...
@Component({
  selector: 'app-kartu-identitas-anak',
  templateUrl: './kartu-identitas-anak.component.html',
  styleUrls: ['./kartu-identitas-anak.component.scss']
})
export class KartuIdentitasAnakComponent implements OnInit {
  ...
  getDocuments() {
    this.dtOptions = {
      ...
      ajax: (dtParams: any, callback :any) => {
        ...
        // Change Api Call to placholder instead of real api
