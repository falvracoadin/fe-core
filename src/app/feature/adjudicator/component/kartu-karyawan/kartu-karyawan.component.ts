...
@Component({
  selector: 'app-kartu-karyawan',
  templateUrl: './kartu-karyawan.component.html',
  styleUrls: ['./kartu-karyawan.component.scss']
})
export class KartuKaryawanComponent implements OnInit {
