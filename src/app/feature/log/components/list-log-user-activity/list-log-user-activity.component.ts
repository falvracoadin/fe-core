...
@Component({
  selector: 'app-list-log-user-activity',
  templateUrl: './list-log-user-activity.component.html',
  styleUrls: ['./list-log-user-activity.component.scss']
})

export class ListLogUserActivityComponent implements OnInit {
